		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#empproject1empdetailproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"empproject1empdetailproject1-display": {
								"semanticObject": "empproject1empdetailproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=empproject1.empdetailproject1",
									"url": sap.ui.require.toUrl("empproject1/empdetailproject1")
								}
							}
						}
					}
